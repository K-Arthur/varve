...
| Current public status | Public beta; latest published application release is `v0.2.0` (published 2026-08-21) |
...
- Treat the latest published application release (currently `v0.2.0`) as the latest
