...
| P3-17 | Spatial-index rectangle queries explode at extreme zoom-out | clean-worktree `pnpm bench` | scene/input | measured | clamp/index large-area queries or switch strategy after measuring candidate correctness | high | zoom 0.01 mean 7.72 s, min 4.91 s, 10 samples | `ca682e07` verification |
