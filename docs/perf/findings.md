...
| P3-16 | Global decoded-image retention ignores the selected memory preset | ownership trace plus failing preset/shrink tests | memory | verified | expose live cache limits and bind the canvas preset to decoded-image bytes | low | 64/256/512 MiB tiers; live shrink evicts to 400-byte test ceiling | decoded-image budget milestone |
