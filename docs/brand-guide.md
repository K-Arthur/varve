...
| Mark only | `strata-icon.svg` | Transparent | Teal/Sandstone/Terracotta flat | — |
| App icon (light) | `strata-app-icon.svg` | `#FAFAF8` rounded-rect | Flat | — |
| App icon (dark) | `strata-app-icon-dark.svg` | `#0D0F14` rounded-rect | Cross-mark sweep | — |
| Symbolic (system) | `strata-icon-symbolic.svg` | Transparent | `currentColor` | — |
| Per-layer gradient — mark | `strata-icon-gradient.svg` | Transparent | Per-layer gradient | — |
...
packages/ui/src/icons/
  strata-icon.svg                        ← master mark (no bg), flat colour
  strata-app-icon.svg                    ← 1024×1024 master with light bg (source for build)
  strata-app-icon-dark.svg               ← 1024×1024 master with dark bg, cross-sweep gradient
  strata-icon-symbolic.svg               ← 16×16 freedesktop symbolic, currentColor
  ...
  strata-icon-gradient.svg               ← mark only, per-layer gradients
...
apps/desktop/src-tauri/icons/
  strata-icon.svg                    ← mark synced (no bg)
  strata.svg                         ← mark + bg (Tauri window icon)
  icon.icns / icon.ico / *.png       ← generated by build-icons.sh
  hicolor/scalable/apps/dev.strata.desktop.svg
  hicolor/symbolic/apps/dev.strata.desktop-symbolic.svg
  hicolor/{16,22,24,32,48,64,96,128,256,512,1024}x*/apps/dev.strata.desktop.png

apps/desktop/public/icons/
  strata-icon.svg / strata-wordmark.svg
