# ADR-0135: Master inheritance and cycle prevention
...
No master-to-master inheritance exists. ADR-0134 defers it. Cycles and
...
- Composition via copies — rejected: inherits ADR-0132 copying defects.

## Consequences

- Multi-layer workflows use independent masters (ADR-0134) until v2.
