...
(ADR-0141): MediaBox = bleed box; TrimBox = trim size; BleedBox = trim +
...
an export-job override that participates in precedence (ADR-0141 D1), never a
separate value.
