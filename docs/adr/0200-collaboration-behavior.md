# ADR-0200: Collaboration behavior
...
D1 — Sync unit = semantic operations (ADR-0198) over stable identities
...
remote edits runs locally from composed inputs (ADR-0187); remote composition
...
and replay depth; remote text is untrusted content (ADR-0201 applies).
