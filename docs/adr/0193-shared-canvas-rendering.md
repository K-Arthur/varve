# ADR-0193: Shared canvas rendering
...
requires placement (ADR-0173) and a page-aware scene walk.
...
Placement bounds (ADR-0173) keep culling math finite; hidden pages never
compose.
