...
section | explicit-pages` (ADR-0178 topology + ADR-0180 sections resolve
...
override controls; selection alone never creates an override (ADR-0182).
...
invariants (ADR-0175) hold for projected nodes too.
