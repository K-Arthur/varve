...
mirrors, and spine-relative geometry (inside/outside bleed, ADR-0190) flips.
...
D4 — Foldouts are explicit custom spreads (`kind: 'foldout'`, ADR-0177) with a
...
None beyond ADR-0177 spread validation.
