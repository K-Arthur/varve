...
There is one editing location for each common property: Position & Size,
Appearance, and Fills remain the canonical owners for persistence, bindings,
and history. Effect parameters open in a focused anchored editor while
secondary effect actions live in the row menu.
