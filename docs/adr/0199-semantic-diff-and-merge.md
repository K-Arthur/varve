# ADR-0199: Semantic diff and merge behavior
...
(membership by spread id, ADR-0177), sections (numbering changes), masters
...
(ADR-0182 D1), story text edit vs frame-link edit, print-geometry change vs
artwork change.
...
- Persisting merged line positions (ADR-0187).
