# ADR-0203: Performance and memory limits
...
ADR-0184); story ≤ 10M graphemes; frames per story ≤ 5,000; columns ≤ 64;
...
loss recovers; browser storage quota errors surface cleanly (ADR-0202 D4).
