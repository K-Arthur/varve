# ADR-0195: Selection across pages
...
shared coordinate service (ADR-0172) and reparents atomically (ADR-0175).

D4 — Inherited master items are selectable under a policy flag (deep
selection through projections, ADR-0181 D5) and always surface override
...
- Undo transactions wrap cross-page moves as one step (ADR-0198).
