# ADR-0197: Legacy document migration
...
Multipage work adds placement (ADR-0173), stories (ADR-0185), spread model
(ADR-0177), master layers (ADR-0183), print geometry (ADR-0190), marks
(ADR-0191).
...
D4 — Shared-root/orphan detection on load (ADR-0175) repairs only with
