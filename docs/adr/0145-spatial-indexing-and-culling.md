# ADR-0145: Spatial indexing and culling
...
D3 — Projection caches (master projections, ADR-0132 D4) are per-page and
...
D4 — The page index is bounded: coordinate limits (ADR-0124) and a
