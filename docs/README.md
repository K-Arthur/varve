...
| `adr/0122-page-vs-frame-semantics.md` | Page versus frame semantics |
| `adr/0123-page-local-vs-world-coordinates.md` | Page-local versus world coordinates |
| `adr/0124-pasteboard-page-placement.md` | Pasteboard page placement |
| `adr/0125-page-order-vs-visual-placement.md` | Page order versus visual placement |
| `adr/0126-page-ownership-of-scene-nodes.md` | Page ownership of scene nodes |
| `adr/0127-global-and-pasteboard-content.md` | Global and pasteboard-only content |
| `adr/0128-explicit-vs-derived-spreads.md` | Explicit versus derived spreads |
...
| `adr/0138-persisted-vs-derived-text-ranges.md` | Persisted versus derived text ranges |
...
| `adr/0153-browser-vs-desktop-capabilities.md` | Browser versus desktop capabilities |
...
| `architecture/persistent-history.md` | Persistent history/version control architecture (identity, canonicalization, typed operations; ADRs 0017-0046) |
...
| `plans/persistent-history-progress.md` | Persistent history/version control milestone tracker (ADRs 0017-0046) |
