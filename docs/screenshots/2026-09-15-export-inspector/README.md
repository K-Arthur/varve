...
| `03b-custom-scale-valid.png` | Custom scale `2.5` accepted | Custom option checked, field valid, primary action enabled |
...
| `08-compact-drawer.png` | Compact inspector drawer (640×700) with the Export tab open | Format/scale work inside the drawer dialog; Escape returns focus to the FAB |
