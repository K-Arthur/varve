...
| `IntelligencePanel` primary views | Audit/intelligence | Content tabs plus overflow | Local view state and menu overflow | Underline + More menu | Make More a button outside the tablist and give the active view a real tabpanel |
