...
test.describe('Visual Awareness marketing surface', () => {
  test('labels the foundation honestly and remains readable on mobile', async ({ page }, testInfo) => {
    ...
    await expect(page.locator('.feature-kicker').getByText('In development', { exact: true })).toBeVisible();
