...
fn main() -> Result<(), String> {
    use base64::Engine;
    use varve_bgremove::{RemovalMethod, RemovalOptions};
    ...
    varve_bgremove::runtime::init_native_runtime(std::path::Path::new(&runtime_path))?;
    ...
    let result = varve_bgremove::remove_background(
        &image,
        &RemovalOptions {
            method,
            tolerance: None,
