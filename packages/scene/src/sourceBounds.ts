/**
 * Source (unwarped) local bounds — canonical geometry bounds without any
 * warp evaluation. Used by the warp evaluator itself and by layout.
 * Extracted from nodeBounds to keep the nodeBounds to warpBounds import
 * graph acyclic (warpBounds computes source bounds via this module).
 */
