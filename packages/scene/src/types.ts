...
export type OpenTypeFeatureTag =
  | 'liga' | 'dlig' | 'sups' | 'subs' | 'numr' | 'dnom'
  | 'frac' | 'afrc' | 'zero' | 'tnum' | 'pnum' | 'onum'
  | 'lnum' | 'smcp' | 'c2sc' | 'pcap' | 'c2pc' | 'unic'
  | 'titl' | 'nalt' | 'expt' | 'fina' | 'medi' | 'init'
  | 'isol' | 'rlig' | 'clig' | 'calt' | 'hlig' | 'liga'
  | 'dlig' | 'curs' | 'mark' | 'mkmk' | 'locl' | 'rclt'
  | 'rvrn' | 'kern' | 'cpsp' | 'case' | 'salt' | 'ss01'
  | 'ss02' | 'ss03' | 'ss04' | 'ss05' | 'ss06' | 'ss07'
  | 'ss08' | 'ss09' | 'ss10' | 'ss11' | 'ss12' | 'ss13'
  | 'ss14' | 'ss15' | 'ss16' | 'ss17' | 'ss18' | 'ss19'
  | 'ss20' | 'cv01' | 'cv02' | 'cv03' | 'cv04' | 'cv05'
  | 'cv06' | 'cv07' | 'cv08' | 'cv09' | 'cv10' | 'cv11'
  | 'cv12' | 'cv13' | 'cv14' | 'cv15' | 'aalt' | 'abvm'
  | 'blwm' | 'ccmp' | 'dist';
