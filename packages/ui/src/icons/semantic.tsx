...
export const SEMANTIC_ICONS = {
  ...
  // Text / layout
  AlignLeft: { outline: 'AlignLeft', filled: 'AlignLeft' },
  AlignCenter: { outline: 'AlignCenter', filled: 'AlignCenterHorizontal' },
  AlignRight: { outline: 'AlignRight', filled: 'AlignRight' },
  AlignJustify: { outline: 'AlignJustify', filled: 'TextAlignJustify' },
