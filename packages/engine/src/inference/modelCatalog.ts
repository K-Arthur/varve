...
const FALLBACK_ENTRIES: ModelManifestEntry[] = [
  ...
  },
  {
    ...
    sizeBytes: 1_376_269,
    remoteUrl: '',
    checksum: '9759400e77755569631f27656e205417d6d6b926bd161dce33f94c700f55c0be',
    bundled: true,
    inputSpec: null,
    quality: 2.5,
    precision: 'int8',
  ...
  {
    id: 'mobile-sam',
    name: 'Faster Prompted Selection',
    description:
      'MobileSAM split ONNX provider for point and box object selection. The multi-mask decoder returns four candidates for cycling; this is a prompted segmenter, not an automatic foreground or semantic detector. The 44.7MB download does not imply low runtime memory: the real-photo Node CPU gate reached ~1.15GB RSS at 1920x2560, and the browser worker path is validated only for explicit experimental use.',
    ...
    maxSessions: 1,
    multiComponent: true,
    source: 'Acly/MobileSAM @ 0d3b403339b4674a82493d5e97964dd78089ddc8',
    sourceLicense: 'MIT',
    components: [
      {
  ...
  },
  {
    ...
    description:
      'MobileSAM image encoder. Input is raw RGB HWC resized with ResizeLongestSide to at most 1024; the graph performs normalization and right/bottom padding. MIT model card, Acly/MobileSAM pinned revision.',
    sizeBytes: 28_157_093,
    remoteUrl:
      'https://huggingface.co/Acly/MobileSAM/resolve/0d3b403339b4674a82493d5e97964dd78089ddc8/mobile_sam_image_encoder.onnx',
    checksum: '580f5fb648ea1062c0aabc26217aed56921985f03f0cbbd852bba81d760cc749',
    ...
    tensorContract: {
      version: 1,
      inputs: [{ name: 'input_image', dims: [-1, -1, 3], dtype: 'float32' }],
      outputs: [{ name: 'image_embeddings', dims: [1, 256, 64, 64], dtype: 'float32' }],
      normalization: {
  ...
  },
  {
    ...
    description:
      'MobileSAM prompt decoder. Returns four source-sized mask logits, raw predicted-IoU ranking scores, and 256x256 low-resolution logits. MIT model card, Acly/MobileSAM pinned revision.',
    sizeBytes: 16_496_559,
    remoteUrl:
      'https://huggingface.co/Acly/MobileSAM/resolve/0d3b403339b4674a82493d5e97964dd78089ddc8/sam_mask_decoder_multi.onnx',
    checksum: '8976b90a87ba50a6a72217a5ff994f7d25ce16f2229fcc1ed259e1294c622ffe',
    ...
    tensorContract: {
      version: 1,
      inputs: [
        { name: 'image_embeddings', dims: [1, 256, 64, 64], dtype: 'float32' },
        { name: 'point_coords', dims: [1, -1, 2], dtype: 'float32' },
        { name: 'point_labels', dims: [1, -1], dtype: 'float32' },
        { name: 'mask_input', dims: [1, 1, 256, 256], dtype: 'float32' },
        { name: 'has_mask_input', dims: [1], dtype: 'float32' },
        { name: 'orig_im_size', dims: [2], dtype: 'float32' },
      ],
      outputs: [
        { name: 'masks', dims: [1, 4, -1, -1], dtype: 'float32' },
        { name: 'iou_predictions', dims: [1, 4], dtype: 'float32' },
        { name: 'low_res_masks', dims: [1, 4, 256, 256], dtype: 'float32' },
      ],
