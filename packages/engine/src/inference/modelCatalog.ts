...
const FALLBACK_ENTRIES: ModelManifestEntry[] = [
  ...
  },
  {
    ...
    name: 'SCUNet Denoise',
    description:
      'Real-world image denoising — removes noise, JPEG artifacts, and grain while preserving detail.',
    sizeBytes: 18_000_000,
    remoteUrl: 'https://huggingface.co/Heliosoph/scunet-onnx/resolve/main/scunet.onnx',
    checksum: '',
    bundled: false,
    inputSpec: null,
    quality: 4,
