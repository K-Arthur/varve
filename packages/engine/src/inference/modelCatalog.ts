...
const FALLBACK_ENTRIES: ModelManifestEntry[] = [
  ...
  },
  {
    ...
    description:
      'MobileSAM split ONNX provider for point and box object selection. The multi-mask decoder returns four candidates for cycling; this is a prompted segmenter, not an automatic foreground or semantic detector. Node CPU RSS peaked at ~548MB with a 1920x1080 source while both sessions were resident; browser validation remains a separate gate.',
