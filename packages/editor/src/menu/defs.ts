...
export function getEditMenu(runAction: (id: string) => void): MenuItemDef[] {
  return [
    ...
    {
      id: 'copyText',
      labelKey: 'menu.edit.copyText',
      kind: 'command',
      group: 'clipboard',
      enabled: enabledWithSelection,
      run: () => runAction('copyText'),
    },
    {
      id: 'copyAsSvg',
      labelKey: 'menu.edit.copyAsSvg',
      kind: 'command',
      group: 'clipboard',
      enabled: enabledWithSelection,
      run: () => runAction('copyAsSvg'),
    },
    {
      id: 'copyAsPng',
      labelKey: 'menu.edit.copyAsPng',
      kind: 'command',
      group: 'clipboard',
      enabled: enabledWithSelection,
      run: () => runAction('copyAsPng'),
    },
    {
      id: 'pastePlainText',
      labelKey: 'menu.edit.pastePlainText',
      kind: 'command',
      group: 'clipboard',
      run: () => runAction('pastePlainText'),
    },
    {
      id: 'pasteSvgMarkup',
      labelKey: 'menu.edit.pasteSvgMarkup',
      kind: 'command',
      group: 'clipboard',
      run: () => runAction('pasteSvgMarkup'),
    },
    {
      id: 'duplicate',
    ...
    {
      id: 'pixelSelection',
      labelKey: 'menu.edit.pixelSelection',
      kind: 'submenu',
      group: 'selection',
      run: () => {},
      items: [
        {
          id: 'toolSelectionPaint',
          labelKey: 'menu.edit.toolSelectionPaint',
          kind: 'command',
          group: 'edit',
          run: () => runAction('toolSelectionPaint'),
        },
        {
          id: 'saveAreaSelection',
          labelKey: 'menu.edit.saveAreaSelection',
          kind: 'command',
          group: 'saved',
          run: () => runAction('saveAreaSelection'),
        },
        {
          id: 'restoreLastSavedAreaSelection',
          labelKey: 'menu.edit.restoreLastSavedAreaSelection',
          kind: 'command',
          group: 'saved',
          run: () => runAction('restoreLastSavedAreaSelection'),
        },
        {
          id: 'deleteLastSavedAreaSelection',
          labelKey: 'menu.edit.deleteLastSavedAreaSelection',
          kind: 'command',
          group: 'saved',
          run: () => runAction('deleteLastSavedAreaSelection'),
        },
        {
          id: 'pathToSelection',
          labelKey: 'menu.edit.pathToSelection',
          kind: 'command',
          group: 'convert',
          run: () => runAction('pathToSelection'),
        },
        {
          id: 'selectionToPath',
          labelKey: 'menu.edit.selectionToPath',
          kind: 'command',
          group: 'convert',
          run: () => runAction('selectionToPath'),
        },
        {
          id: 'selectFromImageAlpha',
          labelKey: 'menu.edit.selectFromImageAlpha',
          kind: 'command',
          group: 'source',
          run: () => runAction('selectFromImageAlpha'),
        },
        {
          id: 'selectFromImageLuminance',
          labelKey: 'menu.edit.selectFromImageLuminance',
          kind: 'command',
          group: 'source',
          run: () => runAction('selectFromImageLuminance'),
        },
        {
          id: 'selectFromImageColorRange',
          labelKey: 'menu.edit.selectFromImageColorRange',
          kind: 'command',
          group: 'source',
          run: () => runAction('selectFromImageColorRange'),
        },
        {
          id: 'areaSelectionGrow',
          labelKey: 'menu.edit.areaSelectionGrow',
          kind: 'command',
          group: 'refine',
          run: () => runAction('areaSelectionGrow'),
        },
        {
          id: 'areaSelectionShrink',
          labelKey: 'menu.edit.areaSelectionShrink',
          kind: 'command',
          group: 'refine',
          run: () => runAction('areaSelectionShrink'),
        },
        {
          id: 'areaSelectionSmooth',
          labelKey: 'menu.edit.areaSelectionSmooth',
          kind: 'command',
          group: 'refine',
          run: () => runAction('areaSelectionSmooth'),
        },
        {
          id: 'areaSelectionThreshold',
          labelKey: 'menu.edit.areaSelectionThreshold',
          kind: 'command',
          group: 'refine',
          run: () => runAction('areaSelectionThreshold'),
        },
        {
          id: 'areaSelectionNudgeUp',
          labelKey: 'menu.edit.areaSelectionNudgeUp',
          kind: 'command',
          group: 'transform',
          run: () => runAction('areaSelectionNudgeUp'),
        },
        {
          id: 'areaSelectionNudgeDown',
          labelKey: 'menu.edit.areaSelectionNudgeDown',
          kind: 'command',
          group: 'transform',
          run: () => runAction('areaSelectionNudgeDown'),
        },
        {
          id: 'areaSelectionNudgeLeft',
          labelKey: 'menu.edit.areaSelectionNudgeLeft',
          kind: 'command',
          group: 'transform',
          run: () => runAction('areaSelectionNudgeLeft'),
        },
        {
          id: 'areaSelectionNudgeRight',
          labelKey: 'menu.edit.areaSelectionNudgeRight',
          kind: 'command',
          group: 'transform',
          run: () => runAction('areaSelectionNudgeRight'),
        },
        {
          id: 'areaSelectionScaleUp',
          labelKey: 'menu.edit.areaSelectionScaleUp',
          kind: 'command',
          group: 'transform',
          run: () => runAction('areaSelectionScaleUp'),
        },
        {
          id: 'areaSelectionScaleDown',
          labelKey: 'menu.edit.areaSelectionScaleDown',
          kind: 'command',
          group: 'transform',
          run: () => runAction('areaSelectionScaleDown'),
        },
        {
          id: 'areaSelectionRotateCW',
          labelKey: 'menu.edit.areaSelectionRotateCW',
          kind: 'command',
          group: 'transform',
          run: () => runAction('areaSelectionRotateCW'),
        },
        {
          id: 'areaSelectionRotateCCW',
          labelKey: 'menu.edit.areaSelectionRotateCCW',
          kind: 'command',
          group: 'transform',
...
export function getViewMenu(
  ...
  return [
    ...
    {
      id: 'resetAllWorkspaces',
      labelKey: 'menu.view.resetAllWorkspaces',
      kind: 'command',
      group: 'workspace',
      run: () => runAction('resetAllWorkspaces'),
    },
    {
      id: 'customizeWorkspace',
      labelKey: 'menu.view.customizeWorkspace',
      kind: 'command',
      group: 'workspace',
      run: () => runAction('customizeWorkspace'),
    },
    {
      id: 'manageWorkspaceLayouts',
      labelKey: 'menu.view.manageWorkspaceLayouts',
      kind: 'command',
      group: 'workspace',
    ...
    },
    {
      ...
      kind: 'command',
      group: 'workspace',
      run: () => runAction('restoreAllPanels'),
    },
    {
      id: 'logoPreview',
  ...
  return [
    ...
    },
    {
      ...
      enabled: (ctx) => {
        ...
        return { reason: 'Select an image layer first' };
      },
      run: () => runAction('resizeImage'),
    },
    {
      id: 'bakeWarp',
      labelKey: 'menu.object.bakeWarp',
      kind: 'command',
      group: 'transform',
      enabled: enabledWithSelection,
    ...
    {
      id: 'fitSelectionToPlane',
      labelKey: 'menu.object.fitSelectionToPlane',
      kind: 'command',
      group: 'transform',
      enabled: enabledWithSelection,
      run: () => runAction('fitSelectionToPlane'),
    },
    {
      id: 'unprojectSelectionFromPlane',
      labelKey: 'menu.object.unprojectSelectionFromPlane',
      kind: 'command',
      group: 'transform',
      enabled: enabledWithSelection,
      run: () => runAction('unprojectSelectionFromPlane'),
    },
    {
      id: 'createIsometricGridArtwork',
      labelKey: 'menu.object.createIsometricGridArtwork',
      kind: 'command',
      group: 'transform',
      run: () => runAction('createIsometricGridArtwork'),
    },
    {
      id: 'openEffectStudio',
    ...
    },
    {
      ...
      accelerator: acceleratorFor('toolPerspective'),
      kind: 'command',
      group: 'image',
      workspaces: ['design', 'print', 'image'],
      enabled: enabledWithSelection,
    ...
    {
      id: 'createMaskFromSelection',
      labelKey: 'menu.object.createMaskFromSelection',
      kind: 'command',
      group: 'addMask',
      workspaces: ['design', 'print', 'drawing', 'image'],
      enabled: enabledWithSelection,
      run: () => runAction('createMaskFromSelection'),
    },
    {
      id: 'loadMaskAsSelection',
      labelKey: 'menu.object.loadMaskAsSelection',
      kind: 'command',
      group: 'addMask',
      workspaces: ['design', 'print', 'drawing', 'image'],
      enabled: enabledWithSelection,
      run: () => runAction('loadMaskAsSelection'),
    },
    {
      id: 'addClipMask',
...
export function getHelpMenu(runAction: (id: string) => void): MenuItemDef[] {
  return [
    ...
    {
      id: 'contactSupport',
      labelKey: 'menu.help.contactSupport',
      kind: 'command',
      group: 'contact',
      run: () => runAction('contactSupport'),
    },
    {
      id: 'sendFeedback',
      labelKey: 'menu.help.sendFeedback',
      kind: 'command',
      group: 'contact',
      run: () => runAction('sendFeedback'),
    },
    {
      id: 'reportSecurity',
      labelKey: 'menu.help.reportSecurity',
      kind: 'command',
      group: 'contact',
      run: () => runAction('reportSecurity'),
    },
    {
      id: 'openPrivacy',
      labelKey: 'menu.help.privacy',
      kind: 'command',
      group: 'contact',
      run: () => runAction('openPrivacy'),
    },
    {
      id: 'whatIsThis',
