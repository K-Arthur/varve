    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: () => 'Restore Last Saved Area Selection',
          kind: 'command',
          group: 'saved',
        ...
        },
        {
          ...
          label: () => 'Delete Last Saved Area Selection',
          kind: 'command',
          group: 'saved',
        ...
        },
        {
          ...
          label: () => 'Select from Image Luminance',
          kind: 'command',
          group: 'source',
