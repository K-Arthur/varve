...
export const MENU_LABELS: Readonly<Record<string, string>> = {
  ...
  'menu.edit.copyText': 'Copy Text',
  'menu.edit.copyAsSvg': 'Copy as SVG',
  'menu.edit.copyAsPng': 'Copy as PNG',
  'menu.edit.pastePlainText': 'Paste as Plain Text',
  'menu.edit.pasteSvgMarkup': 'Paste SVG Markup…',
  ...
  'menu.edit.pixelSelection': 'Pixel Selection',
  'menu.edit.toolSelectionPaint': 'Paint Selection',
  'menu.edit.saveAreaSelection': 'Save Area Selection',
  'menu.edit.restoreLastSavedAreaSelection': 'Restore Last Saved Area Selection',
  'menu.edit.deleteLastSavedAreaSelection': 'Delete Last Saved Area Selection',
  'menu.edit.pathToSelection': 'Path to Selection',
  'menu.edit.selectionToPath': 'Selection to Path',
  'menu.edit.selectFromImageAlpha': 'Select from Image Alpha',
  'menu.edit.selectFromImageLuminance': 'Select from Image Luminance',
  'menu.edit.selectFromImageColorRange': 'Magic Wand from Image',
  'menu.edit.areaSelectionGrow': 'Grow',
  'menu.edit.areaSelectionShrink': 'Shrink',
  'menu.edit.areaSelectionSmooth': 'Smooth',
  'menu.edit.areaSelectionThreshold': 'Threshold',
  'menu.edit.areaSelectionNudgeUp': 'Nudge Up',
  'menu.edit.areaSelectionNudgeDown': 'Nudge Down',
  'menu.edit.areaSelectionNudgeLeft': 'Nudge Left',
  'menu.edit.areaSelectionNudgeRight': 'Nudge Right',
  'menu.edit.areaSelectionScaleUp': 'Scale Up',
  ...
  'menu.view.openPageGuideLayouts': 'Page Guide Layouts…',
  'menu.view.openMasterGuideLayouts': 'Master Guide Layouts…',
  'menu.view.openDocumentGuideLayouts': 'Document Guide Defaults…',
  ...
  'menu.view.workspaceCodegen': 'Workspace: Codegen',
  'menu.view.logoPreview': 'Test Logo at Small Sizes',
  'menu.object.addClearSpaceGuides': 'Generate Clear-Space Guides…',
  'menu.object.fitSelectionToPlane': 'Fit to Plane',
  'menu.object.unprojectSelectionFromPlane': 'Unproject from Plane',
  'menu.object.createIsometricGridArtwork': 'Create Isometric Grid Artwork…',
