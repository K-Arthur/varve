...
export function updateSettings(patch: Partial<EditorSettings>): EditorSettings {
...
export function resetSettings(): EditorSettings {
  ...
  return { export: { ...DEFAULT_EXPORT_SETTINGS }, appearance: { ...DEFAULT_APPEARANCE_SETTINGS } };
}
