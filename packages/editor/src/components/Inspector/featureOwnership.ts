...
export const FEATURE_OWNERSHIP: Record<SectionId, FeatureOwnership> = {
  ...
  warp: {
    ...
    complexity: 'moderate',
    status: 'functional',
    rationale: 'Warp modifier stack is a shape-level property edited per selection.',
  },
  mockups: {
    surface: 'properties',
    scope: 'selection',
    ...
    complexity: 'large-editor',
    status: 'functional',
    rationale: 'Mockup composition is a multi-step workflow that needs its own surface.',
  },
  table: {
    surface: 'properties',
    scope: 'selection',
    ...
    complexity: 'large-editor',
    status: 'functional',
    rationale: 'Table structure editing is a rich data workflow, not routine properties.',
  },
  'table-cells': {
    surface: 'properties',
    scope: 'selection',
    ...
    complexity: 'moderate',
    status: 'functional',
    rationale: 'Cell selection, merge, and content editing while a table is selected.',
  },
  'table-columns': {
    surface: 'properties',
    scope: 'selection',
    ...
    complexity: 'compact',
    status: 'functional',
    rationale: 'Column add/remove/resize are routine structural operations.',
  },
  'table-rows': {
    surface: 'properties',
    scope: 'selection',
    ...
    complexity: 'compact',
    status: 'functional',
    rationale: 'Row add/remove/resize are routine structural operations.',
  },
  'table-appearance': {
    surface: 'appearance',
    scope: 'selection',
