...
export function InteractionTracePanel() {
  ...
  const copyTrace = useCallback(async () => {
    ...
    const payload = {
      ...
      inputToCommitMs: selected.inputToCommitMs,
      inputToNextPaintMs: selected.inputToNextPaintMs,
      deprecated: { pointerToPresentMs: selected.deprecated.pointerToPresentMs },
