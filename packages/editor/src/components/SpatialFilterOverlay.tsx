  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: '50%',
        background: 'color-mix(in srgb, var(--color-canvas-selection) 22%, transparent)',
        boxShadow:
          '0 0 0 1px var(--color-surface-sunken), 0 0 0 5px color-mix(in srgb, var(--color-canvas-selection) 22%, transparent)',
