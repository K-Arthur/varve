...
export const TOOL_REGISTRY = [
  ...
  },
  {
    ...
    aliases: ['slice', 'export slice', 'export region'],
  },
  {
    id: 'knife',
    label: 'Knife',
  ...
  },
  {
    ...
    category: 'selection',
    kind: 'tool',
    aliases: ['colour selection', 'color range', 'magic wand selection'],
  },
  {
    id: 'floatingTransform',
    label: 'Transform Pixels',
    icon: 'Move',
    category: 'raster',
    kind: 'tool',
    aliases: ['floating transform', 'pixel transform', 'transform selected pixels'],
  },
  {
    ...
    category: 'selection',
    kind: 'tool',
    aliases: ['selection boundary', 'transform selection boundary'],
  },
  {
    id: 'table',
    label: 'Table',
