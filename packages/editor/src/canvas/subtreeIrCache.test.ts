...
describe('SubtreeIrCache', () => {
  it('returns cached item when hash matches', () => {
    ...
    const item = { id: 'n1', transform: [1, 0, 0, 1, 0, 0], fill: { space: 'rgb' as const, r: 0, g: 0, b: 0, a: 255 }, opacity: 1, blendMode: 'normal' as const, primitive: { kind: 'rect' as const, w: 10, h: 10 } };
